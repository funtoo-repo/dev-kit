...
SRC_URI="https://download.jetbrains.com/webstorm/WebStorm-2025.1.4.1.tar.gz -> webstorm-2025.1.4.1.tar.gz"
...
src_install() {
	...
	make_desktop_entry ${PN} "WebStorm" ${PN} "Development;IDE;" || die
