...
EGO_SUM=(
	...
	"github.com/antchfx/htmlquery v1.3.4/go.mod"
	...
	"github.com/fsouza/go-dockerclient v1.12.1/go.mod"
	"github.com/geaaru/docker-companion v0.4.6-0.20241113113045-0f9ad14bc226"
	"github.com/geaaru/docker-companion v0.4.6-0.20241113113045-0f9ad14bc226/go.mod"
	...
	"github.com/lxc/incus/v6 v6.11.0/go.mod"
	...
	"github.com/zitadel/logging v0.6.2/go.mod"
	"github.com/zitadel/oidc/v3 v3.37.0"
	"github.com/zitadel/oidc/v3 v3.37.0/go.mod"
	"github.com/zitadel/schema v1.3.1"
	"github.com/zitadel/schema v1.3.1/go.mod"
...
SRC_URI="https://github.com/lxc/distrobuilder/tarball/1f63bd9328ad4605228640a2800f889f658cf8c3 -> distrobuilder-3.2-1f63bd9.tar.gz
https://direct-github.funmore.org/7d/3b/49/7d3b49bd64909c5d4a2238d803f9af74761799959ae20a0f6360c983e6ac5f7a3ce23182e2f7fe5ec27e1ec563a21e75076b0cbede7a09d94f6e6ebeca2c19f0 -> distrobuilder-3.2-funtoo-go-bundle-e5370be7b669b50ff3932a43eb0075f1f21d0fbc48fccf6fdf299f1951408df9b2d51c2e01c87de3731a61b500a7ed1130009bdacd437671b7d10c5d093ae236.tar.gz"

LICENSE="Apache-2.0"
SLOT="0"
KEYWORDS="*"
S="${WORKDIR}/lxc-distrobuilder-1f63bd9"
